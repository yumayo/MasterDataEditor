...
export class NotificationToast {
    ...
    constructor(debugConsole: DebugConsole) {
        ...
        // コンテナ内の並び順: トーストエリア → メッセージ欄
        // トーストエリアは position: absolute でステータスバー上方に展開するため
        // DOM順序はメッセージ欄の前後どちらでも視覚的に変わらないが、意味的にメッセージ欄を最後に配置する
    ...
    /**
     * エラー通知を表示する。
     * メッセージ欄のテキストを更新し、トーストポップアップを表示し、DebugConsole に記録する。
