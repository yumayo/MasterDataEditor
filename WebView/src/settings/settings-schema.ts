...
export const SETTING_DEFINITIONS = {
    ...
    explorerFileDescriptionHidden: defineSetting<boolean>({
        label: 'Explorer説明を隠す',
        type: 'boolean',
        defaultValue: false,
        section: 'display',
        control: 'toggle',
        rootClassNames: ['settings-explorer-file-description-hidden-toggle'],
        inputClassNames: ['settings-explorer-file-description-hidden-checkbox'],
    }),
    tabButtonDescriptionHidden: defineSetting<boolean>({
        label: 'タブ説明を隠す',
        type: 'boolean',
        defaultValue: false,
        section: 'display',
        control: 'toggle',
        rootClassNames: ['settings-tab-button-description-hidden-toggle'],
        inputClassNames: ['settings-tab-button-description-hidden-checkbox'],
    }),
