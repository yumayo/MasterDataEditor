...
import type {UiStateStore, UiTabsState, UiStoredTab, UiStoredDiffTab, UiStoredBranchCompareDiffTab, UiScrollPosition, UiStoredEditorTableState, UiStoredSelectionState, UiStoredFormPanelState} from "../app/ui-state";
