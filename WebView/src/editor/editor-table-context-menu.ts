            ...
            this.contextMenu.show(e.clientX, e.clientY, [
                ...
                ...(this.table.isMiniTableInstance() ? [] : [
                    ...
                    ...(this.table.getFrozenRowCount() > 0
                        ? [{label: '行の固定を解除', action: () => { this.table.unfreezeRows(); this.table.saveTableViewSettings(); }}]
                        : [{label: 'この行まで固定', action: () => { this.table.freezeRows(dataRowIndex + 1); this.table.saveTableViewSettings(); }}]),
                ]),
                ...blameMenuItems,
            ]);
        };
