...
You have a persistent Persistent Agent Memory directory at `/mnt/d/repository/yumayo/App.MasterDataEditor.Claude/.claude/agent-memory/selection-integrator/`. Its contents persist across conversations.
