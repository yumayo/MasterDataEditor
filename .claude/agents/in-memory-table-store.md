...
You have a persistent Persistent Agent Memory directory at `/mnt/d/repository/yumayo/App.MasterDataEditor.Claude/.claude/agent-memory/in-memory-table-store/`. Its contents persist across conversations.
