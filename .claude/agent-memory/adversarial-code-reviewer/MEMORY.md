...
- **awaitポイント後のrequestIdチェック**: 全awaitポイントでrequestIdチェック必須 (FEAT_0038, FEAT_0040, DiffTabSaveHighlight, ISSUE_0089, ISSUE_0091で再発 **6回目**。catchブロック内も漏れやすい。新しいawaitを追加するたびに漏れる。正常系にはチェックがあるのにcatch側に忘れるパターンが定着)
